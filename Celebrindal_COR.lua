function get_sets()
				...
				sets.Preshot.Fomalhaut.ANY = set_combine(sets.Preshot.Fomalhaut,{head="Chass. Tricorne",body="Laksa. Frac +3"})
				
				sets.Preshot.Fomalhaut.RDM = set_combine(sets.Preshot.Fomalhaut.ANY,{feet="Pursuer's Gaiters"})
				
				
				sets.Preshot.Armageddon = {head={ name="Taeon Chapeau", augments={'"Snapshot"+5','"Snapshot"+5',}},
                     body="Oshosi Vest",hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},back={ name="Camulus's Mantle", augments={'"Snapshot"+10',}},waist="Yemaya Belt",legs="Adhemar Kecks",feet="Meg. Jam. +2"}
				
				sets.Preshot.Armageddon.ANY = set_combine(sets.Preshot.Armageddon,{head="Chass. Tricorne",body="Laksa. Frac +3"})
				
				sets.Preshot.Armageddon.RDM = set_combine(sets.Preshot.Armageddon.ANY,{feet="Pursuer's Gaiters"})
				
				
				sets.Preshot['Death Penalty'] = {head={ name="Taeon Chapeau", augments={'"Snapshot"+5','"Snapshot"+5',}},
                     body="Oshosi Vest",hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},back={ name="Camulus's Mantle", augments={'"Snapshot"+10',}},waist="Yemaya Belt",legs="Adhemar Kecks",feet="Meg. Jam. +2"}
				
				sets.Preshot['Death Penalty'].ANY = set_combine(sets.Preshot['Death Penalty'],{head="Chass. Tricorne",body="Laksa. Frac +3"})
				
				sets.Preshot['Death Penalty'].RDM = set_combine(sets.Preshot['Death Penalty'].ANY,{feet="Pursuer's Gaiters"})
				...
				sets.Midshot.HighACC = set_combine(sets.Midshot.MidACC,{head="Laksa. Tricorne +3",
                ...
                sets.Midshot.Fomalhaut.HighACC = set_combine(sets.Midshot.Fomalhaut.MidACC,{head="Laksa. Tricorne +3",
                                body="Laksa. Frac +3",right_ring="Regal Ring",left_ring="Cacoethic Ring +1"})
                ...
                sets.Midshot.Armageddon.HighACC = set_combine(sets.Midshot.Armageddon.MidACC,{head="Laksa. Tricorne +3",
                               body="Laksa. Frac +3",right_ring="Regal Ring",left_ring="Cacoethic Ring +1"})
                ...
                sets.Midshot['Death Penalty'].HighACC = set_combine(sets.Midshot['Death Penalty'].MidACC,{head="Laksa. Tricorne +3",
                                body="Laksa. Frac +3",right_ring="Regal Ring",left_ring="Cacoethic Ring +1"})
